...
COPY --from=build /app/target/messenger-client-2-0.0.1-SNAPSHOT.jar /app/messenger-client-2.jar
...
ENTRYPOINT ["./wait-for-it.sh", "mysql-messenger-client-2:3306", "--", "java", "-jar", "/app/messenger-client-2.jar"]
